...
<div class="row animated fadeIn">
	...
	?>
		...
		<p><a class="button" href="<?php $hol = get_post_meta( $post->ID, '_post_hol', true ); echo $hol; ?>" target="_blank"><i class="fas fa-flask"></i> <?php $holtitle = get_post_meta( $post->ID, '_post_holtitle', true ); echo $holtitle; ?></a></p>
