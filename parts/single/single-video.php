...
<div class="row animated fadeIn">
	...
	?>
		...
		<p><a class="button" href="<?php $video = get_post_meta( $post->ID, '_post_video', true ); echo $video; ?>" target="_blank"><i class="fab fa-youtube"></i> <?php _e( 'Watch on YouTube', 'vmw' ); ?></a></p>
